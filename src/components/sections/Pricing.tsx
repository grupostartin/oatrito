...
export const Pricing = () => {
  return (
    <section id="precos" className="py-32 bg-brand-surface px-4 md:px-16 border-t-2 border-brand-primary">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        
        <h2 className="font-display text-5xl md:text-6xl text-brand-text uppercase mb-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
          {/* Card Premium */}
          <div className="bg-brand-bg border border-brand-surface-var p-8 md:p-12">
            <h3 className="font-mono text-brand-primary tracking-widest uppercase text-sm mb-2 font-bold">Individual</h3>
            <p className="font-display text-4xl text-brand-text uppercase mb-8">Premium</p>
            
            <ul className="space-y-4 font-body text-brand-muted mb-12 border-t border-brand-surface-var pt-8">
          ...
          {/* Card Zen */}
          <div className="bg-brand-primary text-brand-bg border border-brand-primary p-8 md:p-12 relative overflow-hidden">
            ...
            <p className="font-display text-4xl uppercase mb-8">Zen</p>
            
            <ul className="space-y-4 font-body font-medium mb-12 border-t border-brand-bg/20 pt-8 relative z-10 w-full">
            ...
            <Button variant="primary" className="w-full bg-brand-bg text-brand-primary border-brand-bg hover:bg-transparent hover:text-brand-bg hover:border-brand-bg">
              Começar no Zen
            </Button>
          </div>
        </div>

        <p className="font-mono text-sm text-brand-muted mt-12 text-center">
