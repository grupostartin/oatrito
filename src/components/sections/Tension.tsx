...
export const Tension = () => {
  ...
  return (
    <section className="py-32 px-4 md:px-16 bg-brand-bg border-t-2 border-brand-surface-var">
      <div className="max-w-7xl mx-auto">
        <h2 className="font-display text-5xl md:text-6xl text-brand-text uppercase mb-16 max-w-3xl">
        ...
        >
          {/* Card 1 */}
          <motion.div variants={item} className="border-b border-brand-surface-var pb-4 relative group">
        ...
        <motion.p 
          ...
          viewport={{ once: true }}
          className="font-mono text-brand-primary text-center mt-24 text-lg border-2 border-brand-primary p-6 max-w-4xl mx-auto"
        >
